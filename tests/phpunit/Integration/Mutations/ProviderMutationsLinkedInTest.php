 ...
 */
class ProviderMutationsLinkedInTest extends \Tests\WPGraphQL\Login\TestCase {
	/**
	 * The test user ID.
	 *
	 * @var int
	...
	public function setUp(): void {
		...
		$this->set_client_config( 'linkedin', $this->provider_config );
	...
	public function testLoginWithLinkExistingUsers(): void {
		...
		$this->set_client_config( 'linkedin', $config );
