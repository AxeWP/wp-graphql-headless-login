...
use Tests\WPGraphQL\Login\Fixtures\FooGithubProviderConfig;
use WPGraphQL\Login\Auth\User;

/**
 * Tests the GitHub provider mutations.
 */
class ProviderMutationsGithubTest extends \Tests\WPGraphQL\Login\TestCase {
	/**
	 * The test user ID.
	 *
	 * @var int
	...
	public function setUp(): void {
		...
		$this->set_client_config( 'github', $this->provider_config );
	...
	public function testLoginWithLinkExistingUsers(): void {
		...
		$this->set_client_config( 'github', $config );
