...
use Tests\WPGraphQL\Login\Fixtures\FooGoogleProviderConfig;
use WPGraphQL\Login\Auth\User;

/**
 * Tests the Google provider mutations.
 */
class ProviderMutationsGoogleTest extends \Tests\WPGraphQL\Login\TestCase {
	/**
	 * The test user ID.
	 *
	 * @var int
	...
	public function setUp(): void {
		...
		$this->set_client_config( 'google', $this->provider_config );
	...
	public function testLoginWithLinkExistingUsers(): void {
		...
		$this->set_client_config( 'google', $config );
