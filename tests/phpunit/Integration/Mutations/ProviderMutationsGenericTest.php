...
use Tests\WPGraphQL\Login\Fixtures\FooGenericProviderConfig;
use WPGraphQL\Login\Auth\User;

/**
 * Tests the Generic OAuth2 provider mutations.
 */
class ProviderMutationsGenericTest extends \Tests\WPGraphQL\Login\TestCase {
	/**
	 * The test user ID.
	 *
	 * @var int
	...
	public function setUp(): void {
		...
		$this->set_client_config( 'oauth2-generic', $this->provider_config );
	...
	/**
	 * Tests logging in with `useAuthenticationCookie` enabled.
	 */
