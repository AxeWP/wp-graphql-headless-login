...
use Tests\WPGraphQL\Login\Fixtures\FooFacebookProviderConfig;
use WPGraphQL\Login\Auth\User;

/**
 * Tests the Facebook provider mutations.
 */
class ProviderMutationsFacebookTest extends \Tests\WPGraphQL\Login\TestCase {
	/**
	...
	public function setUp(): void {
		...
		$this->set_client_config( 'facebook', $this->provider_config );
	...
	public function testLoginWithLinkExistingUsers(): void {
		...
		$this->set_client_config( 'facebook', $config );
