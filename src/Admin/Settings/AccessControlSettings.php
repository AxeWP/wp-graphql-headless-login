		...
		if ( empty( self::$config ) ) {
			self::$config = [
				'hasAccessControlAllowCredentials'  => [
					...
					'help'        => __( 'If enabled, the `Access-Control-Allow-Credentials` header.', 'wp-graphql-headless-login' ),
					'label'       => __( 'Add Access-Control-Allow-Credentials to headers', 'wp-graphql-headless-login' ),
					'order'       => 1,
					'required'    => false,
					'type'        => 'boolean',
				],
