		...
		if ( empty( self::$config ) ) {
			self::$config = [
				...
				'loginCookieSameSiteOption'        => [
					...
					'help'        => __( 'If the "Set authentication cookie" option is enabled, you can choose the SameSite attribute for authentication. The default value is "Lax". Choose "None" if cross-site access is required, "Lax" for moderate protection, or "Strict" for maximum protection.', 'wp-graphql-headless-login' ),
					'label'       => __( 'Login Authentication - Samesite cookie mode', 'wp-graphql-headless-login' ),
					'order'       => 7,
					'required'    => false,
					'type'        => 'string',
					'enum'        => [
				...
				'loginCookieDomain'                => [
					...
					'label'       => __( 'Login Authentication - Cookie Domain', 'wp-graphql-headless-login' ),
					'order'       => 8,
					'required'    => false,
					'type'        => 'string',
				],
