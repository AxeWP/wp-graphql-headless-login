...
import { AllowedScreens, SCREEN_TITLES } from '@/admin/screens';

import styles from './styles.module.scss';

export const DOCS_URL =
	'https://github.com/AxeWP/wp-graphql-headless-login/blob/main/docs/settings.md';
			...
			<ul role="menubar" className={ styles.menu }>
				{
					...
					Object.entries( SCREEN_TITLES ).map(
						( [ screen, title ] ) => (
							<li key={ screen }>
								<Button
									key={ screen }
